...
function Login() {
  ...
  AOS.init();
  const clientId =
    "513009040271-p09lrpl30dbe94micdr009kevohsapv7.apps.googleusercontent.com";
  ...
  const LoginHandle = async () => {
    try {
      let hasil = await fetch(
        "https://bronze-cape-buffalo-sari.cyclic.app/user/login",
        {
          method: "POST",
          headers: {
            Accept: "*/*",
      ...
      if (hasil.token) {
        ...
        try {
          let userData = await fetch(
            "https://bronze-cape-buffalo-sari.cyclic.app/user/profile",
            {
              method: "GET",
              headers: {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Swal.fire({
          ...
          confirmButtonText:
            '<i className="fa fa-times"></i> Silahkan Login Kembali!',
        });
        navigate("/");
        setLoginButton(true);
                ...
                <>
                  <div id="services">
                    ...
                    <h5 className="section-subheading">
                      Logout membuat akses anda terbatas
                    </h5>
                    <hr />
                    <br />
                  </div>
                ...
                <form className="requires-validation">
                  ...
                  <div className="col-md-12">
                    ...
                    {change === "text" && (
                      <>
                        ...
                        <button
                          className="btn-tombol mt-4"
                          onClick={(e) => hidepassword(e.preventDefault())}
                        >
                          Hide Password
                        </button>
                      </>
                  ...
                  <div className="text-center mt-4">
                    <label className="form-check-label">
                      <h6>
                        <b>
                          I confirm that all data are correct and can be
                          responsible
                        </b>
                      </h6>
                    </label>
